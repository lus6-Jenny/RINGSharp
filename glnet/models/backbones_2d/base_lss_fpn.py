...
try:
    from glnet.ops.voxel_pooling_inference import voxel_pooling_inference
    from glnet.ops.voxel_pooling_train import voxel_pooling_train
except ImportError:
...
class DepthNet(nn.Module):
    ...
    def forward(self, x, mats_dict):
        ...
        mlp_input = self.bn(mlp_input.reshape(-1, mlp_input.shape[-1]).float())
...
class BaseLSSFPN(nn.Module):
    ...
    def create_frustum(self):
        ...
        #print("d_coords shape:", d_coords.shape)
        # D x H x W x 3
    ...
    def _forward_single_sweep(self,
        ...
        #print("sweep_imgs:", sweep_imgs.shape)
        img_feats = self.get_cam_feats(sweep_imgs)
        #print("imge_feats:", img_feats.shape)
        ...
        if self.training or self.use_da:
            ...
            #print("img_feat_with_depth_in shape:", img_feat_with_depth.shape)
